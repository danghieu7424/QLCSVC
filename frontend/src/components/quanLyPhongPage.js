  ...
  const handleSendAddCanBo = () => {
    ...
    fetch(`${API_BASE_URL}/api/insert/quan-ly-phong`, {
      ...
      .then(async (res) => {
        ...
        if (!res.ok) {
          throw new Error(resData.message || "Lỗi gửi dữ liệu.");
        }
        return resData;
      })
      .then((resData) => {
                              ...
                              <ul className="tree-view">
                                <li className="child">
                                  <div className="tree-node">
                                    <span
                                      className={`toggle ${
                                        expanded[`${phongKey}-cb`]
                                          ? "expanded"
                                          : ""
                                      }`}
                                      onClick={() =>
                                        toggleExpand(`${phongKey}-cb`)
                                      }
                                    ></span>
                                ...
                                <li className="child">
                                  <div className="tree-node">
                                    <span
                                      className={`toggle ${
                                        expanded[`${phongKey}-tb`]
                                          ? "expanded"
                                          : ""
                                      }`}
                                      onClick={() =>
                                        toggleExpand(`${phongKey}-tb`)
                                      }
                                    ></span>
