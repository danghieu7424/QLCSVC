        ...
        <header className="box__header">
            <div className="box__header__embrace">
                ...
                <ul className="box__header__title">
                    ...
                    <li>
                        <Link to="/CNTT" className="link-class">
                    ...
                    <li>
                        <Link to="/D_DT" className="link-class">
                        <span href="" className="box__header__title--hover">
                    ...
                    <li>
                        <Link to="/KTCK" className="link-class">
                        <span href="" className="box__header__title--hover">
...
function CNTT() {
    return <h1 style={{ paddingTop: "4rem" }}>CNTT</h1>;
}
function D_DT() {
        ...
        <BrowserRouter>
            <div>
                ...
                <Switch>
                    ...
                    <Route exact path="/CNTT" component={CNTT} />
                    <Route exact path="/D_DT" component={D_DT} />
                    <Route exact path="/KTCK" component={KTCK} />
                </Switch>
            </div>
        </BrowserRouter>
    );
